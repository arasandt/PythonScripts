...
model = Sequential() # one layer after another
model.add(Dense(1, input_dim=1, kernel_initializer='uniform', bias_initializer='uniform', activation='linear'))
model.compile(loss='mean_squared_error', optimizer='sgd')

model.fit(x = train_house_size_norm, y = train_price_norm, epochs = 300)
